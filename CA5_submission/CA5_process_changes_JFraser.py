...
output_file = 'CA5_changes_JF1.csv'
my_file = open(output_file, 'w')
my_file.write('Revision,Author,Date, # Lines, Day, Length, Comment, Files Changes\n')

for commit in commits:
	day1 = commit.date.split("(")
	day2 = day1[1].strip()
	day = day2[0]+day2[1]+day2[2]
	#line adjusted below by JF - to add day of week for each entry
	my_file.write(str(commit.revision) + ',' + commit.author + ',' + commit.date + 
