...
class DieselCar(Car):
    ...
    def getNumberHP(self):
        return self.__numberHP

    def setNumberHP(self, value):
        self.__numberHP = value

class HybridCar(Car):

    def __init__(self):
        Car.__init__(self)
        self.__numberTypes = 2

    def getNumberTypes(self):
        return self.__numberTypes

    def setNumberTypes(self, value):
        self.__numberTypes = value
